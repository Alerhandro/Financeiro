...
<body>
        ...
        <div class="content">
            ...
            <div class="tabela">
                <table>
                    ...
                    <tbody>
                        <?php
                        $consulta = "SELECT desc_receita, valor_receita, pagamento_receita FROM receita";
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>R$ <?= number_format($receita['valor_receita'], 2, ',', '.'); ?></td>
    ...
    <script>
        fetch('http://localhost/PROJETO/Financeiro/api.php')
            .then(response => response.json())
            .then(data => {
                const labels = data.map(item => item.pagamento_receita);
